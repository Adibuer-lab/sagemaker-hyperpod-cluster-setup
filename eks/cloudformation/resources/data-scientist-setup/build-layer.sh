...
echo "Building data scientist setup Lambda layer..."
...
zip -r "${SCRIPT_DIR}/ds-setup-lambda-layer.zip" .

echo "Layer build complete: ${SCRIPT_DIR}/ds-setup-lambda-layer.zip"
